class Swarm extends AIInfo
{
  ...
  function GetDescription()   { return "An AI with its main objective to dominate by connecting all towns by roads and buses, so people may connect more. Higly recommended to set road vehicle limit to 5000 - or higher on very large and town intensive maps."; }
